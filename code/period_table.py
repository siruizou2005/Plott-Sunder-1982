...
Input   out/human_trades.csv          (stage 1, human_trades.py)
Output  tab/period_table.csv          one row per period of every market
...
def main() -> None:
    ...
    hp["layer"] = "L2_human_digitized"
    hp["source"] = "out/human_trades.csv"
    ...
    print(f"tab/period_table.csv  {len(hp)} periods, {hp.shape[1]} columns")
